...
// Name implements Named by returning the Name of the TypeOf(a).
func (a nilPair) Name() string { return TypeOf(a).Name() }

// Name implements Named by returning the Name of the TypeOf(a).
func (a kind) Name() string { return string(a.ID) }

// Name implements Named by returning the Name of the TypeOf(a).
func (a name) Name() string { return string(a) }

// Name implements Named by returning the Name of the TypeOf(a).
func (a Index) Name() string { return TypeOf(a).Name() }

// Name implements Named by returning the Name of the TypeOf(a).
func (a Cardinality) Name() string { return TypeOf(a).Name() }

// Name implements Named by returning the Name of the TypeOf(a).
func (a nest) Name() string { return TypeOf(a).Name() }

// Name implements Named by returning the Name of the TypeOf(a).
func (a Head) Name() string { return TypeOf(a).Name() }

// Name implements Named by returning the Name of the TypeOf(a).
func (a Tail) Name() string { return TypeOf(a).Name() }

// ===========================================================================

// Both implements Pair by returning the Kind and the Type.
func (a nilPair) Both() (aten, apep interface{}) { return KindOfPair(a), nil }

// Both implements Pair by returning the Name and the Type.
func (a kind) Both() (aten, apep interface{}) { return KindOfPair(a).ID, KindOfPair(a).Type }

// Both implements Pair by returning the Kind and the value.
func (a name) Both() (aten, apep interface{}) { return KindOfPair(a), a }

// Both implements Pair by returning the Kind and the value.
func (a Index) Both() (aten, apep interface{}) { return KindOfPair(a), a }

// Both implements Pair by returning the Kind and the value.
func (a Cardinality) Both() (aten, apep interface{}) { return KindOfPair(a), a }

// Both implements Pair by returning both parts of a.
func (a nest) Both() (aten, apep interface{}) { return a.Aten, a.Apep }

// Both implements Pair by returning Both() of the evaluated Head.
func (a Head) Both() (aten, apep interface{}) {
	if a == nil   { return KindOfPair(a), nilHead }
	if a() == nil { return nilPair{}.Both() }
	return a().Both()
}

// Both implements Pair by returning the Head and Tail a evaluates to.
func (a Tail) Both() (aten, apep interface{}) {
	if a == nil { return KindOfPair(a), nil }
	return a()
}
...
// Size implements Pile by returning 0.
func (a nilPair) Size() Cardinality { return Cardinal(0) }

// Size implements Pile by returning 1.
func (a kind) Size() Cardinality { return Cardinal(1) }

// Size implements Pile by returning 1.
func (a name) Size() Cardinality { return Cardinal(1) }
...
func (a Tail) SizeRecursive() Cardinality {
	head, tail := a()
	size, step := Cardinal(0), Cardinal(1)
	if head == nil { return size }
	return size.Add(step, tail.SizeRecursive())
}
